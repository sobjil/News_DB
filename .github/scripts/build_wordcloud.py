...
PROMPT_HEADER = (
    ...
    "■ drop 에 넣을 것(제거):\n"
    "  ① 일상적·행정적·절차적으로 두루 쓰여 변별력이 없는 단어 — 예) 점검, 논의, 대응, 방문,\n"
    "     참석, 간담회, 추진, 계획, 진행, 선정, 시행, 발생, 개최, 회의, 발표, 강조, 당부, 모색,\n"
    "     마련, 확대, 강화 같은 동작·절차·회의·일반 서술어.\n"
    "  ② 사람 이름(인명) — 장관·차관·청장 등 공무원이나 개인 이름은 정책 주제가 아니므로 제거.\n"
    "     예) 송미령, 이승돈, 윤호중 같은 사람 이름.\n"
    "  ③ 정부 부처·청·위원회 등 기관·조직 이름 — 어느 기관인지는 정책 주제가 아니므로 제거.\n"
    "     예) 농촌진흥청, 외교부, 행정안전부, 식약처, 산림청, 금융위원회, 국세청 같은 기관명.\n"
    "■ drop 에 넣지 말 것(보존): 구체적인 정책·기술·산업·제도 주제어, 그리고 고유명사 중\n"
    "  법령·제품·사업명·지역명. 분야를 특정하는 명사(예: 인공지능, 반도체, 원전, 탄소중립,\n"
    "  개인정보, 청년, 저출생, 수출, 농업 등)는 반드시 남기세요. (단, 사람 이름·기관명은 위 ②③으로 제거)\n\n"
    "■ 규칙\n"
    "  - 반드시 아래 입력 목록에 실제로 있는 단어만 drop 에 넣으세요. 새 단어를 만들지 마세요.\n"
    "  - 애매하면 보존하세요(drop 하지 마세요). 과도하게 지우지 마세요. (단, 사람 이름·기관명은 제거)\n"
